...
!!! Note
    ...
    To cancel a subscription, you must be an administrator of the organization.
...
2. In the header, click **Account**.
    ...
    !!! Tip
         ...
         If you are not an administrator of the organization, the **Account** tab will not be visible to you.  
